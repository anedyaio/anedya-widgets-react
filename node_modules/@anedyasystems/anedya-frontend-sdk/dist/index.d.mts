 ...
 */
declare class AnedyaGetDataRequest implements AnedyaGetDataReq {
    variable: string;
    from: number;
    to: number;
    limit: number;
 ...
 */
declare class AnedyaGetDataResponse implements AnedyaGetDataResp {
    isSuccess: boolean;
    error: _errInterface;
    isDataAvailable: boolean;
    data: _ITimeSeriesData | null;
...
interface AnedyaGetLatestDataResp {
    isSuccess?: boolean;
    error: _errInterface;
    isDataAvailable?: boolean;
    data?: _ITimeSeriesData | null;
}
declare class AnedyaGetLatestDataResponse implements AnedyaGetLatestDataResp {
    isSuccess?: boolean;
    error: _errInterface;
    isDataAvailable?: boolean;
    data?: _ITimeSeriesData | null;
...
declare class AnedyaSetKeyRequest implements AnedyaSetKeyReq {
    namespace: {
        scope: "global" | "node";
        id?: string;
    };
...
interface AnedyaSetKeyResp {
    isSuccess: boolean;
    error: _errInterface;
}
declare class AnedyaSetKeyResponse implements AnedyaSetKeyResp {
    isSuccess: boolean;
    error: _errInterface;
    constructor();
}
interface AnedyaGetKeyReq {
    namespace: {
        scope: "global" | "node";
        id?: string;
    };
...
declare class AnedyaGetKeyRequest implements AnedyaGetKeyReq {
    namespace: {
        scope: "global" | "node";
        id?: string;
    };
...
declare class AnedyaGetKeyResponse implements AnedyaGetKeyResp {
    isSuccess: boolean;
    error: _errInterface;
    namespace: {
        scope: string;
...
declare class AnedyaDeleteKeyRequest implements AnedyaDeleteKeyReq {
    namespace: {
        scope: "global" | "node";
        id?: string;
    };
...
interface AnedyaDeleteKeyResp {
    isSuccess: boolean;
    error: _errInterface;
}
declare class AnedyaDeleteKeyResponse implements AnedyaDeleteKeyResp {
    isSuccess: boolean;
    error: _errInterface;
    constructor();
}
interface AnedyaScanKeysReq {
    filter: {
        namespace: {
            scope: "global" | "node";
            id?: string;
...
declare class AnedyaScanKeysRequest implements AnedyaScanKeysReq {
    filter: {
        namespace: {
            scope: "global" | "node";
            id?: string;
...
declare class AnedyaScanKeysResponse implements AnedyaScanKeysResp {
    isSuccess: boolean;
    error: _errInterface;
    count: number;
    totalCount: number;
...
interface AnedyaGetDeviceStatusResp {
    isSuccess: boolean;
    error: _errInterface;
    data: any;
}
declare class AnedyaGetDeviceStatusResponse implements AnedyaGetDeviceStatusResp {
    isSuccess: boolean;
    error: _errInterface;
    data: any;
    constructor();
}
interface AnedyaGetSnapshotReq {
    time: number;
    variable: string;
}
declare class AnedyaGetSnapshotRequest implements AnedyaGetSnapshotReq {
    time: number;
    variable: string;
...
interface AnedyaGetSnapshotResp {
    isSuccess: boolean;
    error: _errInterface;
    count: number;
    data: NodeVariableValues;
}
declare class AnedyaGetSnapshotResponse implements AnedyaGetSnapshotResp {
    isSuccess: boolean;
    error: _errInterface;
    count: number;
    data: NodeVariableValues;
...
export { Anedya, AnedyaDataType, AnedyaDeleteKeyRequest, type AnedyaDeleteKeyResp, AnedyaDeleteKeyResponse, AnedyaError, AnedyaGetDataRequest, AnedyaGetDataResponse, type AnedyaGetDeviceStatusResp, AnedyaGetDeviceStatusResponse, AnedyaGetKeyRequest, type AnedyaGetKeyResp, AnedyaGetKeyResponse, AnedyaGetLatestDataResponse, AnedyaGetSnapshotRequest, AnedyaGetSnapshotResponse, AnedyaScanKeysRequest, type AnedyaScanKeysResp, AnedyaScanKeysResponse, AnedyaScope, AnedyaSetKeyRequest, type AnedyaSetKeyResp, AnedyaSetKeyResponse, getAnedyaErrorMessage };
